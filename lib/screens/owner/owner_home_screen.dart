...
class _OwnerHomeScreenState extends State<OwnerHomeScreen>
  ...
  Widget buildMyBidsCard() {
    return Card(
      elevation: 3,
      child: GestureDetector(
        onTap: () {
          Navigator.pushNamed(context, MyBidsView.routeName);
        },
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text(
                AppLocalizations.of(context).translate('my_bids'),
                style: Theme.of(context)
                    .textTheme
                    .headline6
              ...
              StreamBuilder<QuerySnapshot>(
                  stream: OwnerController.getOwnerActiveBids(
                      SessionController.getOwnerInfoFromLocal().ownerId),
                  builder: (context, snapshot) {
                    int count = 0;
                    if (snapshot.hasData) {
                      if (snapshot.data != null) {
