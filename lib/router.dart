    ...
    switch (settings.name) {
      case Start.routeName:
        ...
        return MaterialPageRoute(
            builder: (_) => view,
            settings: RouteSettings(name: Start.routeName));
      case AddCustomer.routeName:
        AddCustomer view = locator<AddCustomer>();
        return MaterialPageRoute(
            builder: (_) => view,
            settings: RouteSettings(name: AddCustomer.routeName));
      case CreditBook.routeName:
        CreditBook view = locator<CreditBook>();
        return MaterialPageRoute(
            builder: (_) => view,
            settings: RouteSettings(name: CreditBook.routeName));
      case GetOrGivePayment.routeName:
        ...
        return MaterialPageRoute(
            builder: (_) => view,
            settings: RouteSettings(name: GetOrGivePayment.routeName));
      ...
      case MyBidsView.routeName:
        return MaterialPageRoute(
            ...
            settings: RouteSettings(name: MyBidsView.routeName));
      case BidDetailsView.routeName:
        return MaterialPageRoute(
            builder: (_) {
              BidDetailsViewArguments args = settings.arguments;
      ...
      case OrdersView.routeName:
        return MaterialPageRoute(
            ...
            settings: RouteSettings(name: OrdersView.routeName));
      case OwnerProfile.routeName:
        return MaterialPageRoute(
            builder: (_) => locator<OwnerProfile>(),
            settings: RouteSettings(name: OwnerProfile.routeName));
      case OwnerHomeScreen.routeName:
        return MaterialPageRoute(
            builder: (_) => locator<OwnerHomeScreen>(),
            settings: RouteSettings(name: OwnerHomeScreen.routeName));
      case OwnerNearByView.routeName:
        return MaterialPageRoute(
            builder: (_) => locator<OwnerNearByView>(),
            settings: RouteSettings(name: OwnerNearByView.routeName));
      ...
      case BidPostedView.routeName:
        return MaterialPageRoute(
            builder: (_) {
              BidPostedViewArguments args = settings.arguments;
      ...
      case OwnerEditProfile.routeName:
        return MaterialPageRoute(
            ...
            settings: RouteSettings(name: OwnerEditProfile.routeName));
      ...
      case Categories.routeName:
        return MaterialPageRoute(
            ...
            settings: RouteSettings(name: Categories.routeName));
      case PickLocation.routeName:
        return MaterialPageRoute(
            builder: (_) => locator<PickLocation>(),
            settings: RouteSettings(name: PickLocation.routeName));
      case CustomerHomeScreen.routeName:
        return MaterialPageRoute(
            builder: (_) => locator<CustomerHomeScreen>(),
            settings: RouteSettings(name: CustomerHomeScreen.routeName));
      case NewRequestView.routeName:
        return MaterialPageRoute(
            builder: (_) => locator<NewRequestView>(),
            settings: RouteSettings(name: NewRequestView.routeName));
...
//            settings: RouteSettings(name: NewRequestSecondView.routeName));
      case RequestPreviewView.routeName:
        ...
        return MaterialPageRoute(
            builder: (_) => view,
            settings: RouteSettings(name: RequestPreviewView.routeName));
      case RequestHomeView.routeName:
        return MaterialPageRoute(
            builder: (_) => locator<RequestHomeView>(),
            settings: RouteSettings(name: RequestHomeView.routeName));
      case SeeBidsView.routeName:
        return MaterialPageRoute(
            builder: (_) {
              SeeBidsViewArguments args = settings.arguments;
              return SeeBidsView(
                request: args.request,
              );
            },
      ...
      case AcceptBidView.routeName:
        return MaterialPageRoute(
            builder: (_) {
              AcceptBidViewArguments args = settings.arguments;
      ...
      case CustomerNearByView.routeName:
        return MaterialPageRoute(
            ...
            settings: RouteSettings(name: CustomerNearByView.routeName));
